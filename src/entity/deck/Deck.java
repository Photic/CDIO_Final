...
public class Deck {
	...
	public Deck(TextReader text) {
		...
		this.deck = new Card[] {
				...
				new PayMoneyPrHouseHotelCard(description[18], 5, new int[] {800*0, 800*2, 800*3, 800*4, 2_300}),
				new PayMoneyPrHouseHotelCard(description[19], 5, new int[] {500*0, 500*2, 500*3, 800*4, 2_000}),
